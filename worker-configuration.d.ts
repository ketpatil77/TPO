/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b90d42b7ca2a810f327cba5c21ce2d05)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	NODE_ENV: "production";
	CLOUDFLARE_WORKER: "true";
	ALLOWED_ORIGINS: "https://tpo-placement-portal.ketan-tpo-portal.workers.dev";
	PORT: string;
	JWT_SECRET: string;
	SUPABASE_URL: string;
	SUPABASE_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "CLOUDFLARE_WORKER" | "ALLOWED_ORIGINS" | "PORT" | "JWT_SECRET" | "SUPABASE_URL" | "SUPABASE_KEY">> {}
}

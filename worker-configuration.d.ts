/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4d0f316f4efc64c48205691024b7f883)
// Runtime types generated with workerd@1.20260903.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	TPO_CACHE: KVNamespace;
	CERTIFICATE_VAULT: R2Bucket;
	CERTIFICATE_FRAUD_QUEUE: Queue;
	ASSETS: Fetcher;
	NODE_ENV: "production";
	CLOUDFLARE_WORKER: "true";
	ALLOWED_ORIGINS: "https://ait.ait-placement-portal.workers.dev";
	VAPID_PUBLIC_KEY: "BFkWk7IB0kGMCb-QcL6QUL0g4uX4dq50tXnFQ3vfpu6NV6Hh4-29vJa4oop-UYEqj6mj4G7yun5f-RyS5aBB-Tg";
	VAPID_SUBJECT: "mailto:ket.patil77@gmail.com";
	PUSH_COMPLETION_THRESHOLD: "80";
	PUSH_REMINDER_CRON: "0 4 */3 * *";
	PROOF_EXPIRY_CRON: "0 * * * *";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "CLOUDFLARE_WORKER" | "ALLOWED_ORIGINS" | "VAPID_PUBLIC_KEY" | "VAPID_SUBJECT" | "PUSH_COMPLETION_THRESHOLD" | "PUSH_REMINDER_CRON" | "PROOF_EXPIRY_CRON">> {}
}

...
function evaluate(type,item) {
  ...
  return classify(100,['Unsupported submission type.']);
}

module.exports = { evaluate, projectRisk, researchRisk, internshipRisk, certificateRisk, isJunk, validHttps, githubLike, doiLike };

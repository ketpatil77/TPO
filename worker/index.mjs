...
function patchDashboardHtml(html, assetPath) {
    ...
    if (assetPath === '/dashboard.html') {
        patched = patched.replace('</head>', '<link rel="stylesheet" href="/css/profile-requirements-20260814.css"><link rel="stylesheet" href="/css/student-projects-pro.css?v=20260904-projects1"><script src="/js/notification-settings-recovery.js?v=20260904-settings1" defer></script><script src="/js/student-projects-pro.js?v=20260904-projects1" defer></script></head>');
    }
    return patched;
}

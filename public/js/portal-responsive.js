(() => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (document.body.classList.contains('student-dashboard-page')) {
            ...
            loadStylesheet('/css/certificate-vault.css?v=20260902-1', 'certificate-vault-css');
            loadScript('/js/certificate-vault-ui.js?v=20260902-1', 'certificate-vault-ui-js');
        }
        ...
        if (document.body.classList.contains('observer-shell')) {
            ...
            loadScript('/js/tpc-layout-v2.js?v=20260902-5', 'tpc-layout-v2-js');

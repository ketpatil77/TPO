...
test('important update interruption hands off once to the in-app inbox', () => {
...
test('student dashboard loads the cache-busted inbox experience', () => {
  assert.match(worker, /notification-inbox-experience\.js\?v=20260904-inbox1/);
});
